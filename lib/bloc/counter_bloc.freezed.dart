...
abstract class $CounterStateCopyWith<$Res> {
  ...
  $Res call({int counter, bool isLoading});
}
...
class _$_CounterState implements _CounterState {
  const _$_CounterState({required this.counter, this.isLoading = false});
  ...
  @override
  String toString() {
    return 'CounterState(counter: $counter, isLoading: $isLoading)';
  }
...
abstract class _CounterState implements CounterState {
  const factory _CounterState(
      {required final int counter, final bool isLoading}) = _$_CounterState;
